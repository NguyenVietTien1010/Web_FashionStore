...
function addProductToTable(user) {
	...
	if (!user) {
		s += `
			<tr>
				<td colspan="7"> 
					<h1 style="color:pink; background-color:white; font-weight:bold; text-align:center; padding: 15px 0;font-size:0.5cm">
						Bạn chưa đăng nhập, cần đăng nhập để mua hàng
					</h1> 
				</td>
			</tr>
		`;
		...
		s += `
			<tr>
				<td colspan="7"> 
					<h1 style="color:red; background-color:white; font-weight:bold; text-align:center; padding: 15px 0;font-size:0.5cm">
						Giỏ hàng trống, quay lại trang chủ để mua hàng
					</h1> 
				</td>
			</tr>
		`;
