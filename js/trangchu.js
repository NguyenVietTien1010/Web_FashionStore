window.onload = function () {
	...
	addBanner("img/banners/banner1.png", "img/banners/banner2.png");
	...
	var tags = ["Uniqlo", "Dior", "Chanel", "Gap", "H&M"];
	for (var t of tags) addTags(t, "index.html?search=" + t);

	var company = ["uniqlo.png", "Adidas.jpg", "Nike.jpg", "Prada.jpg", "Dior.jpg", "Supreme.jpg",
		"Gucci.jpg", "Gap.jpg", "Zara.jpg", "CalvinKlein.jpg", "Hermes.jpg", "LouisVuitton.jpg",
		"Levi's.jpg", "Chanel.jpg", "H&M.jpg"
	];
	...
	if (filters.length) { // có filter
		...
		addKhungSanPham('GIÁ ƯU ĐÃI CỰC HOT', green, ['price=0-3000000', 'sort=price'], soLuong, div);
	}
