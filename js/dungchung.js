...
// dùng bản copy để chắc chắn ko ảnh hưởng tới bản chính
...
function animateCartNumber() {
    ...
    cn.style.transition = 'transform 0.6s ease, background-color 0.6s ease, color 0.6s ease';
    cn.style.transform = 'scale(1.5) rotate(360deg)';
    cn.style.backgroundColor = 'rgba(0, 128, 0, 0.8)';
    cn.style.color = 'pink';
    setTimeout(function () {
        cn.style.transform = 'scale(1) rotate(0deg)';
...
function logIn(form) {
    ...
    alert('Vui lòng kiểm tra lại tên và mật khẩu');
    form.username.focus();
    return false;
}
...
function addTopNav() {
	...
	<div class="top-nav group">
        <section>
            ...
            <a class="fa fa-facebook" href="https://www.facebook.com/uniqlovnam" target="_blank"></a>
            <a class="fa fa-google" href="https://www.uniqlo.com/vn/vi/" target="_blank"></a>
            <a class="fa fa-youtube" href="https://www.youtube.com/@uniqlovietnam2317" target="_blank"></a>            
            </div>
